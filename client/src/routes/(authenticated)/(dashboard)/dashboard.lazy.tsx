...
function Dashboard() {
  ...
  return(
    <>
    <div className='flex flex-col bg-0 h-max'>
      <Toolbar />
      <main className='flex h-full'>
        <Sidebar 
        /> 
        <section className='h-full sm:w-full min-h-dvh pb-[15ch] pt-4 px-4 sm:py-4 sm:px-6 bg-slate-200 sm:bg-slate-50 sm:rounded-tl-xl sm:rounded-bl-xl shadow-md sm:overflow-auto'><Outlet /></section>
      </main>
      <Navbar 
      />
    </div>
